...
#define LAYOUT_atreus_base( \
  ...
  LAYOUT_atreus_wrapper( \
    L01,     L02,     L03,      L04,      L05,                        R01,     R02,      R03,     R04,     R05, \
    L11,     L12,     L13,      L14,      L15,                        R11,     R12,      R13,     R14,     R15, \
    L21,     L22,     L23,      L24,      L25,                        R21,     R22,      R23,     R24,     R25, \
    LC(ESC), LG(TAB), LA(LBRC), LS(RBRC), NM(BSCP), ED(ESC), DB(TAB), SM(SPC), RS(MINS), RA(EQL), RG_QUOT, RC(ENT) \
  )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_atreus_wrapper( /* Qwerty */
    ...
    ________________BOTTOM_L4__________________, ____THUMB_R4____, ________________BOTTOM_R4__________________
  ),
  [_DVORAK] = LAYOUT_atreus_wrapper( /* Dvorak */
  ...
  [_COLEMAK] = LAYOUT_atreus_wrapper( /* Colemak */
...
//#ifdef UNICODE_H
  ...
  [_RUSSIAN] = LAYOUT_atreus_wrapper(
    ...
    ________________BOTTOM_L4__________________, ____THUMB_R4____, ________________CYRLC_R4___________________
  ),
