...
void keyboard_post_init_user(void) {
  IS31FL3733_set_color_all(0, 0, 0); // off
  IS31FL3733_set_color(5-1, 255, 0, 0); // red
  IS31FL3733_set_color(9-1, 255, 165, 0); // orange
  IS31FL3733_set_color(13-1, 255, 255, 0); // yellow
  IS31FL3733_set_color(17-1, 0, 255, 0); // green
  IS31FL3733_set_color(21-1, 0, 0, 255); // blue
  IS31FL3733_set_color(25-1, 128, 0, 128); // purple
}
